...
<div id="wrap">
  <div class="header">
    ...
    <div id="menu">
      ...
      <ul> <li><a href="index.jsp">首页</a></li>
        ...
        <li><a href="about.jsp">关于我们&nbsp;&nbsp; <br /></a></li>
         <li>     </li>
      </ul>
    </div>
  </div>
  <div class="center_content">
    <div class="left_content">
      <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>书籍</div><div class="feat_prod_box">
        ...
        <div class="prod_det_box">
          ...
          <div class="box_center">
            <div class="prod_title"><span style="color: rgb(5, 70, 126); font-family: Arial,Helvetica,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(247, 238, 255); display: inline ! important; float: none;">图书名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">流浪地球</span></span></div>
            <p class="details"><br /></p>
            <a href="servlet/booklist?bookname=35" class="more" >- 更多细节 -</a>
            <div class="clear"></div>
          </div>
      ...
      <div class="feat_prod_box">
        ...
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center"><span style="color: rgb(5, 70, 126); font-family: Arial,Helvetica,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(247, 238, 255); display: inline ! important; float: none;">图书名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">奥当女孩</span></span>
            <p class="details"><br /></p>
            <a href="servlet/booklist?bookname=2" class="more">- 更多细节 -</a>
            <div class="clear"></div>
          </div>
          <div class="box_bottom"></div>
        </div>
      ...
      <div class="feat_prod_box">
        ...
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center"><span style="color: rgb(5, 70, 126); font-family: Arial,Helvetica,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(247, 238, 255); display: inline ! important; float: none;">图书名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">马罗丽成长记</span></span>
            <p class="details"><br /></p>
            <a href="servlet/booklist?bookname=11" class="more">- 更多细节 -</a>
            <div class="clear"></div>
          </div>
          <div class="box_bottom"></div>
        </div>
      ...
      <div class="feat_prod_box">
       <div class="prod_img"><a href="servlet/booklist?bookname=7"><img src="picture/wenxuecihousi.png" width="100" height="100" /></a></div>
        <div class="prod_det_box">
          <div class="box_top"></div>
          <div class="box_center">
            <div class="prod_title"><span style="color: rgb(5, 70, 126); font-family: Arial,Helvetica,sans-serif; font-size: 13px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(247, 238, 255); display: inline ! important; float: none;">图书名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">此后再无余生</span></span></div>
            <p class="details"><br /></p>
            <a href="servlet/booklist?bookname=7" class="more" >- 更多细节 -</a>
            <div class="clear"></div>
          </div>
          <div class="box_bottom"></div>
        </div>
      ...
      <div class="feat_prod_box">
      <div class="title"><span class="title_icon"><img src="images/bullet2.gif" alt="" title="" /></span><span style="color: rgb(5, 70, 126); font-family: Arial,Helvetica,sans-serif; font-size: 19px; font-style: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; background-color: rgb(247, 238, 255); display: inline ! important; float: none;">分类书</span></div>
      <div class="new_products">
        <div class="new_prod_box"> 3～6岁宝宝睡前成长故事
    ...
    <div class="right_content">
      ...
      <div class="right_box">
        ...
        <div class="new_prod_box">刑事辩护的理念
        ...
        <div class="new_prod_box">DK少儿音乐大百科
      ...
      <div class="right_box">
        ...
        <br /><ul class="list">
          ...
          <li><br /></li>
          <li><a href="#">文学类</a></li>
          <li><a href="#">科普类</a></li><li><a href="#">小说类</a></li>
          <li><a href="#">少儿类</a></li>
          <li><a href="#">传记类</a></li>
          <li><a href="#">历史类</a></li>
          </ul>
  ...
  <div class="footer">
    ...
    <div class="right_footer"> <div class="right_footer"> <a href="index.htm">首页</a> <a href="about.htm">关于我们</a> <a href="#">服务 </a> <a href="#">隐私政策</a> <a href="contact.htm">联系我们</a>  </div><a href="#"><br /></a><a href="#"></a> </div>
  </div>
</div>
