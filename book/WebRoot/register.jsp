  ...
  <div class="center_content">
    <div class="left_content">
      ...
      <div class="feat_prod_box_details">
        <p class="details"> <font face="华文仿宋">&nbsp;&nbsp;一个书店，温暖一座城市，带你领略独立书店之美。欢迎你来到我们书店，希望我们会给你带来不同的感受。</font></p>
        <div class="contact_form">
          ...
          <form name="register" action="servlet/AddServlet">
            ...
            <div class="form_row">
              <label class="contact"><strong>用户积分:</strong></label>
              <input type="text" name="level" class="contact_input" /> </div>
              <div class="form_row">
               <label class="contact"><strong>用户权限:</strong></label>
              <input type="text" name="power" class="contact_input" />
            </div>
            <div class="form_row">
              <div class="terms">
                <input type="checkbox" name="terms" />
                我同意 <a href="#">条款和条件</a> </div>
            </div>
            <div class="form_row">
    ...
    <div class="right_content">
     ...
     <div class="title"><span class="title_icon"><img height="18" width="21" src="images/cart.gif" alt="" title="" /></span><a href="servlet/cartt?userid=<%=session.getAttribute("userid")%>" class="view_cart">我的购物车</a><span class="title_icon"></span><a href="servlet/pay" class="view_cart">我的订单</a></div><a href="servlet/pay" class="view_cart"></a><div class="cart"> 
      ...
      <div class="about">
        <p> <img src="images/about.gif" alt="" title="" class="right" /> <font face="华文仿宋">&nbsp;&nbsp;一个书店，温暖一座城市，你领略独立书店之美欢。迎你来到我们书店，希望我们会给你带来不同的感受。</font></p>
      </div>
      <div class="right_box">
        <div class="title"><span class="title_icon"><img src="images/bullet4.gif" alt="" title="" /></span>特价</div>
        <div class="new_prod_box">头条都是他
        ...
        <div class="new_prod_box">生活需要仪式感
