...
public class booklist1 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<Userinfo> userlist=bookService.finduser_();
		 List<Bookinfo> booklist=bookService.findAll_();
		...
		response.sendRedirect("../shouyie.jsp");
